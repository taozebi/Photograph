...
import static com.ewide.photograph.common.util.ConstUtils.*;
import static com.ewide.photograph.common.util.ConstUtils.DAY;
import static com.ewide.photograph.common.util.ConstUtils.HOUR;
import static com.ewide.photograph.common.util.ConstUtils.MIN;
import static com.ewide.photograph.common.util.ConstUtils.MSEC;
import static com.ewide.photograph.common.util.ConstUtils.SEC;
...
public class TimeUtils {
     ...
     *                         K:mm a    3:44 下午
     *               EEE, MMM PrintBitmap, ''yy    星期五, 八月 12, '16
     *          hh 'o''clock' a, zzzz    03 o'clock 下午, 中国标准时间
     *   yyyyy.MMMMM.dd GGG hh:mm aaa    02016.八月.12 公元 03:44 下午
     *     EEE, PrintBitmap MMM yyyy HH:mm:ss Z    星期五, 12 八月 2016 15:44:40 +0800
     ...
     *
     * @param time 要格式化的时间
     * @param formatContext 需要格式的类型 如 yyyy-MM-dd
     * @return
     */
    public static String StringToStringTime(String time, String formatContext) {
        String foramtTime = time;
        ...
        try {
             ...
             */
            SimpleDateFormat format = new SimpleDateFormat(formatContext);
            // 格式化时间 2018-07-17
            Date date = format.parse(time);
            // 输出结果 2018-07-17
            foramtTime = format.format(date);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return foramtTime;
    ...
    public static String getCurTime() {
        return date2String(new Date(), DEFAULT_YMD);
    }
