 ...
 * <ol>
 * <li>use LogUtils.PrintBitmap(),you could print whether the method execute,and the default tag is current class's name</li>
 * <li>use LogUtils.PrintBitmap(msg),you could print log as before,and you could location the method with a click in Android Studio Logcat</li>
 * <li>use LogUtils.json(),you could print json string with well format automatic</li>
 * </ol>
 *
 * @author zhaokaiqiang
...
public final class LogUtils {
    ...
    private static void printStackTrace() {
        ...
        for (String trace : traceString) {
            if (trace.contains("at com.socks.library.LogUtils")) {
                continue;
            }
