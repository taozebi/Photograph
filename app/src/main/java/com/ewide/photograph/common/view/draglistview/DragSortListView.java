...
package com.ewide.photograph.common.view.draglistview;
...
public class DragSortListView extends ListView {
    ...
    private void drawDivider(int expPosition, Canvas canvas) {
        ...
        // Log.PrintBitmap("mobeta", "div="+divider+" divH="+dividerHeight);
        ...
        if (divider != null && dividerHeight != 0) {
            ...
            if (expItem != null) {
                ...
                // Log.PrintBitmap("mobeta", "l="+l+" t="+t+" r="+r+" b="+b);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (mFloatView != null) {
            ...
            canvas.save();
            // Log.PrintBitmap("mobeta", "clip rect bounds: " + canvas.getClipBounds());
     ...
     * @param position 
     * @param top
     * # height Height of item at position. If -1, this function
    ...
    private boolean updatePositions() {
        ...
        // Log.PrintBitmap("mobeta", "float mid="+mFloatViewMid);

        int itemPos = startPos;
        int itemTop = startTop;
        if (mFloatViewMid < edge) {
            // scanning up for float position
            // Log.PrintBitmap("mobeta", "    edge="+edge);
            while (itemPos >= 0) {
                itemPos--;
        ...
        if (mAnimate) {
            ...
            // Log.PrintBitmap("mobeta", "edgeTop="+edgeTop+" edgeBot="+edgeBottom);
    ...
    /**
     * Cancel a drag. Calls {@link #stopDrag(boolean, float)}  with
    ...
    private void adjustOnReorder() {
        ...
        // Log.PrintBitmap("mobeta", "first="+firstPos+" src="+mSrcPos);
        if (mSrcPos < firstPos) {
            ...
            // Log.PrintBitmap("mobeta", "top="+top+" fvh="+mFloatViewHeight);
    ...
    private int getChildHeight(int position) {
        ...
        if (v != null) {
            ...
            if (childHeight != -1) {
                // Log.PrintBitmap("mobeta", "found child height in cache!");
                return childHeight;
            }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // Log.PrintBitmap("mobeta", "onMeasure called");
        if (mFloatView != null) {
    ...
    protected boolean onDragTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_CANCEL:
                ...
                break;
            case MotionEvent.ACTION_UP:
                // Log.PrintBitmap("mobeta", "calling stopDrag from onDragTouchEvent");
                if (mDragState == DRAGGING) {
                    stopDrag(false);
                }
                doActionUpOrCancel();
    ...
    private void doDragFloatView(int movePos, View moveItem, boolean forceInvalidate) {
        ...
        if (updated) {
            ...
            // Log.PrintBitmap("mobeta", "  adjust scroll="+scroll);
    ...
    private void updateFloatView() {
        ...
        // Log.PrintBitmap("mobeta", "dragView top=" + (y - mDragDeltaY));
        // Log.PrintBitmap("mobeta", "limit=" + limit);
        // Log.PrintBitmap("mobeta", "mDragDeltaY=" + mDragDeltaY);
     ...
     * items are lifted (see {@link #setDragEnabled(boolean)} .
    ...
    private class DragScroller implements Runnable {
        ...
        public void run() {
            ...
            if (scrollDir == UP) {
                View v = getChildAt(0);
                // Log.PrintBitmap("mobeta", "vtop="+v.getTop()+" padtop="+padTop);
                if (v == null) {
                    mScrolling = false;
                    return;
                } else {
            ...
            mPrevTime = mCurrTime;
            // Log.PrintBitmap("mobeta", "  updated prevTime="+mPrevTime);
